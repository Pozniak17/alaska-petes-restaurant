            ...
            <div className={styles.second_wrapper}>
              <div className={styles.about_wrapper}>
                ...
                <p className={styles.about_text}>
                  Alice Waters is a celebrated American chef, restaurateur,
                  author, and activist known for her dedication to sustainable,
                  locally sourced food. She founded Chez Panisse, a famed
                  Berkeley restaurant that embodies the farm-to-table
                  philosophy. Waters emphasizes fresh, organic ingredients from
                  local producers who prioritize environmental care,
                  transforming how people think about food and its connection
                  to the environment.
                </p>
