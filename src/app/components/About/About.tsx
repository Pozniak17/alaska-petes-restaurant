          ...
          <div className={styles.second_wrapper}>
            <div className={styles.about_wrapper}>
              ...
              <p className={styles.about_text}>
                ...
                locally sourced food. She founded Chez Panisse, a famed Berkeley
                ...
                prioritize environmental care, transforming how people think
                about food and its connection to the environment.
              </p>
